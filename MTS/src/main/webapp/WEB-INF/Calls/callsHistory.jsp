		...
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="searchCalls.mnt" method="get"
						...
						<table class="tableGeneral">
							...
							<tr>
								...
								<td> <form:select path="callNumber" cssClass="select">
<form:option value="">--Select--</form:option>
<form:options items="${callNumbers}"/>
</form:select> 
			<input type="submit" value="<s:message code="label.search"/>" class="btn btn-primary" /></td>
			...
			<%-- 	<c:forEach var="callsPopup" items="${callsPopup}">
					...
					<display:table id="callsRow" name="callsPopup"
							requestURI="callsEditHome.mnt" pagesize="5" class="grid-table">
